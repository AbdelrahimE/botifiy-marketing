...
لاختبار `generate_lead` يجب أن تكون متغيرات Supabase صحيحة وأن تنجح رسالة الترحيب
إلى رقم واتساب مسجل. Google Sheets اختياري ولا يمنع نجاح الطلب إذا كان Supabase
يعمل.
