          ...
          <div className="legal-content">
            ...
            <div>
              ...
              <ul className="space-y-4 list-disc list-inside">
                <li>
                  <strong>طلبات تفعيل بوتيفاي:</strong> الاسم، رقم واتساب، نوع
                  النشاط، احتياجات النشاط والخطة المختارة، حتى نتمكن من مراجعة
                  الطلب والتواصل معك.
                </li>
                <li>
                  <strong>بيانات مصدر الزيارة:</strong> مثل UTM، معرّفات الحملة
                  والإعلان، صفحة الدخول والمصدر المحيل. ولقياس أداء الإعلانات قد
                  نحفظ معرّف نقرة Meta وملفات القياس المرتبطة بها.
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-4 list-disc list-inside">
                ...
                <li>
                  <strong>Meta:</strong> نستخدم Meta Pixel وConversions API لقياس
                  أداء إعلانات Facebook وInstagram.
                  قد نرسل حدث زيارة أو طلب تفعيل، ومعرّفات القياس، ونوع المتصفح
                  وعنوان IP، ونسخة مطبّعَة ومشفرة أحاديًا من الاسم ورقم الهاتف
                  لتحسين مطابقة الحدث. لا نرسل نوع النشاط أو احتياجاته كبيانات
                  تعريف شخصية إلى واجهة المتصفح.
                </li>
                <li>
            ...
            <div>
              ...
              <p>
                نستخدم ملفات ضرورية لحماية نموذج طلب التفعيل وحفظ مصدر الزيارة،
                كما نستخدم أدوات التحليلات وقياس الإعلانات لفهم أداء الموقع
                والحملات وتحسينهما.
              </p>
              <ul className="mt-4 space-y-2 list-disc list-inside">
                <li><strong>ضرورية:</strong> تعمل دائمًا ولا تستخدم لبناء جمهور إعلاني.</li>
                <li><strong>تحليلات:</strong> تساعدنا على فهم أداء الصفحات وتحسين الموقع.</li>
                <li><strong>إعلانات:</strong> تقيس نتائج حملات Meta وتساعد على إسناد طلب التفعيل للإعلان.</li>
              </ul>
              <p className="mt-4">
                يمكنك إدارة ملفات الارتباط أو حذفها من إعدادات متصفحك. قد يؤثر
                حظر بعض أدوات القياس في دقة إسناد الطلب إلى الحملة، لكنه لا يمنعك
                من إرسال طلب تفعيل بوتيفاي.
              </p>
            </div>
            <hr className="my-8" />
