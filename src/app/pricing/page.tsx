        ...
        <main className="min-h-screen bg-gradient-to-br from-primary-light/20 via-white to-primary-light/80" dir="rtl">
          ...
          <section className="relative bg-gradient-to-br from-primary-light/20 via-white to-primary-light/80 py-24 pt-32">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              {/* Trust Badge */}
              <div className="flex items-center justify-center gap-2 bg-[#60DE2E] px-6 py-1.5 rounded-full shadow-sm mb-6 w-fit mx-auto">
              ...
              <div className="relative flex items-center justify-center p-1 border-2 border-primary/20 rounded-full mb-6 backdrop-blur-xl bg-gradient-to-r from-white/20 via-white/30 to-white/20 w-fit mx-auto"
                style={{
                  background: 'linear-gradient(135deg, rgba(96, 222, 46, 0.1) 0%, rgba(255, 255, 255, 0.2) 50%, rgba(96, 222, 46, 0.1) 100%)',
                  backdropFilter: 'blur(20px)',
                  WebkitBackdropFilter: 'blur(20px)'
                }}>
                <div className="absolute inset-0 rounded-full bg-gradient-to-r from-primary/5 via-transparent to-primary/5 opacity-50"></div>
                <button
                  onClick={() => handleBillingPeriodChange('monthly')}
                  className={`relative z-10 px-4 py-2 rounded-full text-sm font-semibold transition-all duration-300 ease-out ${billingPeriod === 'monthly'
                ...
                <button
                  ...
                  className={`relative z-10 px-4 py-2 rounded-full text-sm font-semibold transition-all duration-300 ease-out ${billingPeriod === 'yearly'
                    ? 'bg-gradient-to-r from-primary via-primary to-primary/80 text-white'
                    : 'text-primary-dark/70 hover:text-primary hover:bg-white/20'
                    }`}
                  style={{
              ...
              <div className="pt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {plans.map((plan) => (
                  <Card
                    key={plan.id}
                    className={`flex flex-col relative ${plan.highlight || plan.secondaryHighlight
                  ...
                  >
                    ...
                    {(plan.highlight || plan.secondaryHighlight) && plan.badge && (
                      <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                        <Badge className={`${plan.highlight ? 'bg-primary' : 'bg-purple-600'
