          ...
          <article className="legal-document mx-auto max-w-5xl">
            ...
            <div className="legal-content">
              <div>
                ...
                <p>
                  بوتيفاي هي منصة SaaS متخصصة في تقديم أدوات أتمتة وتسويق عبر واتساب عبر مسح الكيو آر كود. نهدف إلى تسهيل إدارة المحادثات، الحملات، وتحسين تجربة خدمة العملاء بذكاء وسرعة.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 list-disc list-inside">
                  ...
                  <li>
                    يُمنع إعادة بيع أو تأجير المنصة أو أي من خدماتها بدون إذن مسبق.
                  </li>
                  <li>
