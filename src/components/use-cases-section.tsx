...
const useCases = [
  {
    ...
    description:
      "العميل يسأل عن منتج، وبوتيفاي يرد فوراً بالاختيارات المناسبة: السعر، الشحن، تفاصيل المنتج، أو إتمام الطلب. ولو العميل خرج، يتم متابعته تلقائياً.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "بدل ما يطلب العميل المنيو وينتظر الرد، بوتيفاي يرسل له الخيارات فوراً: المنيو، العروض، الفروع، أو الحجز.",
    bullets: [
      "إرسال المنيو فوراً.",
      "قوائم للأقسام والعروض.",
      "متابعة أو تأكيد الحجز تلقائياً.",
    ],
  ...
  },
  {
    ...
    description:
      "الطالب يسأل عن السعر أو محتوى الكورس أو موعد الدفعة. بوتيفاي يرسل الخيارات المناسبة، يوضح التفاصيل، ويتابع المهتمين تلقائياً.",
    bullets: [
    ...
    scenario: {
      ...
      events: [
        ...
        {
          type: "business",
          text: "سعر الكورس 499 جنيه، والدفع متاح على دفعتين.\nتحب أرسل لك تفاصيل التسجيل؟",
          time: "7:32",
          read: true,
        },
