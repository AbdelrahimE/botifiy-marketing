...
const journeySteps = [
  {
    ...
    description:
      "كل حاجة بتبدأ من سؤال بسيط على واتساب : السعر، التوفر، الحجز، أو تفاصيل الخدمة. من هنا رحلة العميل جوه بوتيفاي تبدأ فعلياً.",
  ...
  },
  {
    ...
    description:
      "بدل ما يقرا رسايل طويلة، العميل بيشوف أزرار واضحة أو قائمة تساعده يوصل للي يدور عليه بسرعة وبضغطة واحدة.",
  ...
  },
  {
    ...
    description:
      "لما العميل يبعت البيانات اللي محتاجها ، بوتيفاي يكتشفها ويرد عليه فوراً برسالة تأكيد ، وفي نفس الوقت يوسمه بعلامة ( Tag ) توضح لفريقك إن العميل ده جاهز يتقفل ، فيبقى سهل عليكم تلاقوه وتكملوا معاه بسرعة.",
      ...
      <div className="relative z-10 mx-auto max-w-container px-5 sm:px-6">
        <div className="journey-reveal mx-auto max-w-4xl text-center" data-journey-reveal>
          ...
          <p className="mx-auto mt-4 max-w-3xl text-base leading-8 text-white/80 sm:text-lg">
            تبني رحلة العميل مرة واحدة بس، وبوتيفاي يمشيها تلقائياً مع كل عميل جديد: يفهم قصده، يرد عليه، يديله اختيارات، يبعتله كل التفاصيل، ويتابعه في التوقيت الصح.
          </p>
        </div>
        ...
        >
          <div className="relative z-10">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-white/65 sm:text-lg">
              بدل الرد اليدوي والمتابعة العشوائية ، خلّي كل محادثة واتساب تمشي في مسار واضح يناسب طبيعة نشاطك وميضيعش اي فرصة بيع محتملة.
            </p>
