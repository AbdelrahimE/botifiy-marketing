...
const businessBenefits: BusinessBenefit[] = [
  ...
  },
  {
    ...
    description:
      "كل عميل سأل ومكملش، بوتيفاي يرسل له متابعة في الوقت الصح من غير ما تفتكر أو تكتب بنفسك. الصفقات اللي كانت هتضيع... بقت ترجع لوحدها.",
    badge: "مسارات متابعة تلقائية",
  },
  {
    icon: UserCheck,
    badgeIcon: Bot,
    title: "مش محتاج تكرر نفس الردود... ركز على البيع",
    description:
      "بوتيفاي يرد على الأسئلة المكررة تلقائيًا، عشان الموظفين يتفرغوا للعملاء الجادين وإغلاق صفقات أكتر",
    badge: "رد تلقائي ذكي",
  },
  {
    ...
    description:
      "بدل ما يقرأ ويسأل ويستنى، بوتيفاي يبعتله أزرار واختيارات واضحة يوصل بيها للي عايزه في ثواني.",
  ...
  },
  {
    ...
    description:
      "مفيش محادثة بتقف عند (تمام - شكرًا). كل عميل بياخد خطوة أقرب للقرار من أول رسالة لحد ما يشتري... كل ده بيحصل بشكل تلقائي مع بوتيفاي.",
      ...
      <div className="relative z-10 mx-auto max-w-container px-5 sm:px-6">
        ...
        >
          <p className="mx-auto max-w-3xl text-3xl md:text-4xl font-medium leading-snug text-white">
            واتسابك اللي بتستخدمه كل يوم… هيتحول لقناة بيع حقيقية مع بوتيفاي، مش مجرد ردود محفوظة
          </p>
          <a
